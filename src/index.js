...
app.post('/estimate-gas', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, endpointId, amount, isBaseNetwork, optionsData, walletProvider, provider, signer, estimatedGas, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, endpointId = _a.endpointId, amount = _a.amount, isBaseNetwork = _a.isBaseNetwork, optionsData = _a.optionsData, walletProvider = _a.walletProvider;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 4, , 5]);
            ...
            case 2:
                signer = _b.sent();
                return [4 /*yield*/, (0, functions_1.estimateSendFees)(endpointId, amount, isBaseNetwork, optionsData, signer)];
            case 3:
