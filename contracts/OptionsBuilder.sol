...
contract OptionsGenerator {
    ...
    function createCombinedOptions(uint128 _receiveGas, uint128 _receiveValue, uint16 _composeIndex, uint128 _composeGas, uint128 _composeValue, uint128 _dropAmount, bytes32 _dropReceiver) public pure returns(bytes memory) {
